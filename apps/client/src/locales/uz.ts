export const uz = {
  translation: {
    ...
    free: "Bepul",
    useBonusPoints: "Bonuslarni ishlatish",
    bonusBalance: "Mavjud bonuslar",
    bonusPointsHint:
      "1 bonus = 1 so'm. Buyurtma summasidan ko'p ishlatib bo'lmaydi.",
    bonusApplied: "Ishlatilgan bonuslar",
    useMaxBonus: "Maksimal ishlatish",
    bonusInputPlaceholder: "Qancha ishlatish kerak?",
    bonusExceedsBalance: "Hisobingizda yetarli bonus yo'q",
    bonusExceedsOrder: "Buyurtma summasidan ko'p ishlatib bo'lmaydi",
