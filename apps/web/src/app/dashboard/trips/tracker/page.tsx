...
export default function TripTrackerPage() {
  const t = useTranslations("tripTracker");
      ...
      {isLoading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-lg font-medium">{t("noActiveTrips")}</p>
            <p className="text-muted-foreground">{t("allTripsCompleted")}</p>
          </CardContent>
        </Card>
      ) : (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {trip.currentStop && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span>
                          {t("currentStop", { name: trip.currentStop.name })}
                        </span>
                      </div>
                    )}
