...
export const TOP_PRODUCTS = [
  { name: "Cappuccino", sales: 89, revenue: 2_670_000, maxSales: 89 },
  { name: "Latte", sales: 72, revenue: 2_520_000, maxSales: 89 },
  { name: "Americano", sales: 64, revenue: 1_280_000, maxSales: 89 },
  { name: "Hot Chocolate", sales: 38, revenue: 1_140_000, maxSales: 89 },
  { name: "Mocha", sales: 31, revenue: 1_085_000, maxSales: 89 },
];
...
export const ALERTS = [
  {
    id: "1",
    type: "error" as const,
    title: "SOLIQ-02 offline",
    message: "No connection > 3 hours. Last ping: 11:23",
    machine: "VM-016",
  ...
  },
  {
    id: "2",
    type: "error" as const,
    title: "Metro Chilanzar offline",
    message: "No connection > 2 hours. Payment terminal",
    machine: "VM-005",
  ...
  },
  {
    ...
    title: "Low stock: KIUT Library",
    message: "Milk remaining for ~15 servings",
    machine: "VM-004",
  ...
  },
  {
    id: "4",
    type: "warning" as const,
    title: "Low stock: BC Zum",
    message: "Coffee beans for ~18 servings",
    machine: "VM-015",
  ...
  },
  {
    id: "5",
    type: "warning" as const,
    title: "High temperature: Cardiology",
    message: "Temperature 95°C (normal ≤93°C)",
    machine: "VM-008",
  ...
  },
  {
    ...
    message: "INHA-01 and TTU-01 — maintenance",
...
export const ACTIVITY_FEED: {
  ...
  },
  {
    ...
    machine: "VM-008",
    detail: "Operator: Alisher",
    time: "15 min ago",
  },
  {
    id: 3,
    type: "sale",
    text: "Sale: Latte + Croissant",
    machine: "VM-006",
    detail: "50 000 UZS",
    time: "18 min ago",
  },
  {
    id: 4,
    type: "alert",
    text: "Machine went offline",
    machine: "VM-005",
    detail: "No connection > 2 hours",
    time: "25 min ago",
  },
  {
    id: 5,
    type: "task",
    text: "Task completed: Cleaning",
    machine: "VM-007",
    detail: "Bakhtiyor",
    time: "32 min ago",
  },
  ...
  },
  {
    ...
    machine: "VM-009",
    detail: "Technician: Sardor",
    time: "2 hours ago",
  },
  {
    id: 9,
    type: "sale",
    text: "Sale: Hot Chocolate",
    machine: "VM-003",
    detail: "30 000 UZS",
    time: "2 hours ago",
  },
  ...
  },
  {
    id: 11,
    type: "refill",
    text: "Loading: milk, beans",
    machine: "VM-004",
    detail: "Operator: Dilshod",
    time: "3 hours ago",
  },
  {
    id: 12,
