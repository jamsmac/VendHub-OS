...
export class SnakeNamingConvention1707000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // ============================================================
    const hasOrgContracts = await queryRunner.hasTable(
    ...
    // ============================================================
    const hasOrgInvitations = await queryRunner.hasTable(
    ...
    // ============================================================
    const hasOrgAuditLogs = await queryRunner.hasTable(
    ...
    const hasMachineLocationHistory = await queryRunner.hasTable(
      "machine_location_history",
    );
    ...
    const hasMachineComponents =
      await queryRunner.hasTable("machine_components");
    ...
    const hasMachineErrorLogs =
      await queryRunner.hasTable("machine_error_logs");
    ...
    const hasRecipeIngredients =
      await queryRunner.hasTable("recipe_ingredients");
    ...
    const hasContractorInvoices = await queryRunner.hasTable(
      "contractor_invoices",
    );
    ...
    // 20. MAINTENANCE
    // ============================================================
    const hasMaintenanceRequests = await queryRunner.hasTable(
    ...
    const hasMaintenanceSchedules = await queryRunner.hasTable(
    ...
    // ============================================================
    const hasCollectionRecords =
      await queryRunner.hasTable("collection_records");
