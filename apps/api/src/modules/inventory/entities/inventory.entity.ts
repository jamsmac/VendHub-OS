...
export class MachineInventory extends BaseEntity {
  ...
  @ApiPropertyOptional({
    example: "A-12",
    description: "Slot/bin number in machine",
  })
  ...
  get fillPercentage(): number {
    ...
    return Math.round(
      (Number(this.currentQuantity) / Number(this.maxCapacity)) * 100,
    );
  }
}
...
export class InventoryMovement extends BaseEntity {
  ...
  @ApiPropertyOptional({
    description: "Operator ID (for operator-related movements)",
  })
  @Column({ type: "uuid", nullable: true })
  operatorId?: string;
  ...
  @ApiPropertyOptional({
    description: "Machine ID (for machine-related movements)",
  })
  @Column({ type: "uuid", nullable: true })
  machineId?: string;
  ...
  @ApiPropertyOptional({
    description: "Actual operation date (may differ from createdAt)",
  })
  @Column({ type: "timestamptz", nullable: true })
  operationDate?: Date;
...
export class InventoryReservation extends BaseEntity {
  ...
  @ApiProperty({
    ...
    description: "Unique reservation number",
  })
  ...
  @ApiProperty({
    enum: InventoryLevel,
    description: "Inventory level (warehouse/operator)",
  })
  @Column({ type: "varchar", length: 20 })
  inventoryLevel: InventoryLevel;

  @ApiProperty({
    description: "Reference ID (warehouse org ID or operator ID)",
  })
  @Column({ type: "uuid" })
  referenceId: string;
...
export class InventoryAdjustment extends BaseEntity {
  ...
  @ApiProperty({
    description: "Reference ID (warehouse, operator, or machine ID)",
  })
  @Column({ type: "uuid" })
  referenceId: string;
...
export class InventoryCount extends BaseEntity {
  ...
  @ApiProperty({
    example: "CNT-2025-001234",
    description: "Unique count number",
  })
  @Column({ type: "varchar", length: 50, unique: true })
  countNumber: string;
