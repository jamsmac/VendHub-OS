...
export class CommissionTierDto {
  ...
  @ApiPropertyOptional({
    description: "Maximum revenue for this tier (null = unlimited)",
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
...
export class CreateContractDto {
  ...
  @ApiPropertyOptional({
    description: "Commission rate percentage (for PERCENTAGE type)",
    example: 15.5,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: "Fixed commission amount (for FIXED type)",
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    description: "Fixed commission period: monthly, quarterly",
    maxLength: 20,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: "Commission tiers (for TIERED type)",
  ...
  @ApiPropertyOptional({
    description: "Payment type: prepaid, postpaid",
    maxLength: 50,
  })
  @IsOptional()
  @IsString()
