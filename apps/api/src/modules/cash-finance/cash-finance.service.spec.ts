...
describe("CashFinanceService", () => {
  ...
  describe("createDeposit", () => {
    ...
    it("should set notes to null when not provided", async () => {
      const dtoNoNotes: CreateDepositDto = {
        amount: 100000,
        date: "2026-03-01",
      };
      const created = {
      ...
      const deposits = [
        {
          ...
          organizationId: orgId,
          amount: 100000,
          depositDate: new Date("2026-03-02"),
        },
        {
          id: "dep-2",
          organizationId: orgId,
  ...
  describe("removeDeposit", () => {
    ...
    it("should throw NotFoundException when deposit does not exist", async () => {
      ...
      await expect(service.removeDeposit(depositId, orgId)).rejects.toThrow(
        NotFoundException,
      );
    });
