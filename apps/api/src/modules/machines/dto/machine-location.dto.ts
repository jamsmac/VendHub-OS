...
export class MoveMachineDto {
  ...
  @ApiPropertyOptional({
    description: "Human-readable address of the new location",
  })
  @IsOptional()
  @IsString()
  address?: string;
...
export class LogErrorDto {
  ...
  @ApiPropertyOptional({
    description: "Additional context data (telemetry snapshot, etc.)",
  })
  @IsOptional()
...
export class ScheduleMaintenanceDto {
  @ApiProperty({
    example: "cleaning",
    description:
      "Type of maintenance (cleaning, inspection, calibration, etc.)",
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    example: "2025-06-15",
    description: "Scheduled date for maintenance (YYYY-MM-DD)",
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiPropertyOptional({
    description: "UUID of the user assigned to perform maintenance",
  })
  @IsOptional()
  @IsUUID()
  ...
  @ApiPropertyOptional({
    description: "Repeat interval in days for recurring maintenance",
  })
  @IsOptional()
  @IsNumber()
