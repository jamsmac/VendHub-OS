...
export class AlertRule extends BaseEntity {
  ...
  @ApiPropertyOptional({
    description: "Maximum threshold (for BETWEEN condition)",
  })
  ...
  @ApiPropertyOptional({
    description: "Machine ID (null = all machines in org)",
  })
  ...
  @ApiProperty({
    description: "Cooldown between alerts in minutes",
    default: 60,
  })
...
export class AlertHistory extends BaseEntity {
  ...
  @Column({
    type: "enum",
    enum: AlertHistoryStatus,
    default: AlertHistoryStatus.ACTIVE,
  })
