...
export class RecipeIngredientDto {
  ...
  @ApiPropertyOptional({
    enum: UnitOfMeasure,
    description: "Unit of measure for this ingredient",
  })
  @IsOptional()
...
export class CreateRecipeDto {
  @ApiProperty({
    example: "Эспрессо классический",
    description: "Recipe name in Russian",
  })
  @IsString()
  @IsNotEmpty()
  @MaxLength(200)
  ...
  @ApiPropertyOptional({
    description: "Machine-specific settings for preparation",
  })
  @IsOptional()
  @IsObject()
