...
describe("ProductsService", () => {
  ...
  let _recipeIngredientRepository: jest.Mocked<Repository<RecipeIngredient>>;
  let _recipeSnapshotRepository: jest.Mocked<Repository<RecipeSnapshot>>;
  ...
  let _supplierRepository: jest.Mocked<Repository<Supplier>>;
  ...
  describe("calculateRecipeCost", () => {
    ...
    it("should throw NotFoundException for non-existent recipe", async () => {
      ...
      await expect(service.calculateRecipeCost("non-existent")).rejects.toThrow(
        NotFoundException,
      );
    });
  });
