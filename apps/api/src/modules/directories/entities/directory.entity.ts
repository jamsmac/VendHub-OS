...
export class Directory extends BaseEntity {
  ...
  @ApiProperty({
    description: "Unique directory code (latin)",
    example: "units",
  })
  @Column({ type: "text" })
  slug: string;
  ...
  @Column({
    type: "enum",
    enum: DirectoryScope,
    enumName: "directory_scope",
    default: DirectoryScope.HQ,
  })
  scope: DirectoryScope;

  @ApiPropertyOptional({
    description: "Organization ID (for ORGANIZATION scope)",
  })
  ...
  @ApiProperty({
    description: "Whether directory supports hierarchy",
    default: false,
  })
  ...
  @ApiProperty({
    description: "System directory (cannot be deleted)",
    default: false,
  })
  @Column({ type: "boolean", default: false })
  isSystem: boolean;
...
export class DirectoryField extends BaseEntity {
  ...
  @ApiProperty({
    description: "System field name (for API)",
  ...
  @ApiPropertyOptional({
    description: "Source directory for SELECT/REF field types",
  })
  @Column({ type: "uuid", nullable: true })
  refDirectoryId: string | null;

  @ApiProperty({
    description: "Allow free text input for SELECT",
    default: false,
  })
  @Column({ type: "boolean", default: false })
  ...
  @ApiProperty({
    description: "Whether field value must be unique per organization",
    default: false,
  })
  @Column({ type: "boolean", default: false })
...
export class DirectoryEntry extends BaseEntity {
  ...
  @ApiPropertyOptional({
    description: "Parent entry ID (for hierarchical directories)",
  })
  @Column({ type: "uuid", nullable: true })
  ...
  @ApiProperty({
    description: "Origin: OFFICIAL or LOCAL",
    enum: EntryOrigin,
