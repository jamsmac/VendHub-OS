...
describe("ReconciliationService", () => {
        ...
        },
        {
          ...
          useValue: {
            ...
            createQueryBuilder: jest
              .fn()
              .mockReturnValue(mockMismatchQueryBuilder),
          },
        },
        {
  ...
  describe("deleteRun", () => {
    ...
    it("should throw NotFoundException when run not found", async () => {
      ...
      await expect(service.deleteRun("non-existent")).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it("should throw BadRequestException when run is pending", async () => {
      ...
      await expect(service.deleteRun("run-uuid-1")).rejects.toThrow(
        BadRequestException,
      );
    });
  });
