...
export class PaymentsController {
  ...
  @ApiResponse({
    status: 400,
    description: "Invalid input or Payme not configured",
  })
  createPayme(
  ...
  @ApiResponse({
    status: 400,
    description: "Invalid input or Click not configured",
  })
  createClick(
    @Body() dto: CreatePaymentDto,
    @CurrentUser("organizationId") organizationId: string,
  ...
  @ApiResponse({
    status: 400,
    description: "Invalid input or Uzum not configured",
  })
  createUzum(
  ...
  @Public()
  @ApiOperation({
    summary: "Payme webhook callback (JSON-RPC, Basic Auth verified)",
  })
  ...
  @Public()
  @ApiOperation({
    summary: "Uzum Bank webhook callback (HMAC SHA-256 verified)",
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "List payment transactions with pagination and filters",
  })
  ...
  @ApiOperation({
    summary:
      "Get aggregated transaction statistics (revenue, counts by provider/status)",
  })
  @ApiResponse({ status: 200, description: "Transaction statistics" })
  getTransactionStats(@CurrentUser("organizationId") organizationId: string) {
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Get a single payment transaction with its refunds",
  })
