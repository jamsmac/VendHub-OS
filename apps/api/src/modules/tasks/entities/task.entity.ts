...
export class Task extends BaseEntity {
  ...
  @ApiPropertyOptional({
    description: "Actual operation date (for offline/historical)",
  })
  @Column({ type: "timestamptz", nullable: true })
  operationDate?: Date;
  ...
  @OneToMany(() => TaskComponent, (component) => component.task, {
    cascade: true,
  })
...
export class TaskItem extends BaseEntity {
  ...
  @ApiPropertyOptional({
    description: "Actual quantity (filled on completion)",
  })
