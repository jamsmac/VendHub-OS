 ...
 */
export const VALID_MAINTENANCE_TRANSITIONS: Record<
  MaintenanceStatus,
  MaintenanceStatus[]
> = {
...
export class MaintenanceRequest extends BaseEntity {
  ...
  // Relations
  @OneToMany(() => MaintenancePart, (part) => part.maintenanceRequest, {
    cascade: true,
  })
  parts: MaintenancePart[];

  @OneToMany(() => MaintenanceWorkLog, (log) => log.maintenanceRequest, {
    cascade: true,
  })
