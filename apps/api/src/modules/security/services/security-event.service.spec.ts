...
describe("SecurityEventService", () => {
  ...
  describe("cleanup", () => {
    it("should soft-delete old resolved events with default retention", async () => {
      repo.softDelete!.mockResolvedValue({ affected: 42 });
    ...
    it("should use custom retention period", async () => {
      repo.softDelete!.mockResolvedValue({ affected: 10 });
