...
import {
  QueryTelegramUsersDto,
  UpdateTelegramUserDto,
  VerifyTelegramUserDto,
} from "./dto/telegram-user.dto";
import {
...
export class TelegramBotController {
  ...
  async updateTelegramUser(
    ...
    // Apply updates
    await this.telegramBotService.getTelegramUser(id);
  ...
  async verifyTelegramUser(@Body() dto: VerifyTelegramUserDto) {
    return this.telegramBotService.verifyUser(
      dto.telegramId,
