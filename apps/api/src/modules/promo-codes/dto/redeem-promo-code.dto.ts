...
export class RedeemPromoCodeDto {
  ...
  @ApiPropertyOptional({
    description: "Order amount before discount (UZS)",
    example: 120000,
  })
  @IsOptional()
  @IsNumber()
...
export class ValidatePromoCodeDto {
  ...
  @ApiProperty({
    description: "Organization UUID (required for public validation)",
  })
  @IsUUID()
  organizationId: string;

  @ApiPropertyOptional({
    description: "Client user UUID for per-user limit check",
  })
  @IsOptional()
  @IsUUID()
  clientUserId?: string;
  ...
  @ApiPropertyOptional({
    description: "Order amount to check minimum threshold (UZS)",
    example: 80000,
  })
  @IsOptional()
  @IsNumber()
