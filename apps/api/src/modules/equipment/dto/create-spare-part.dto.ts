...
export class CreateSparePartDto {
  ...
  @ApiPropertyOptional({
    description: "Compatible component types",
    default: [],
  })
  @IsArray()
  ...
  @ApiPropertyOptional({
    description: "Minimum quantity for reorder",
    default: 0,
  })
  @IsInt()
  @Min(0)
...
export class SparePartQueryDto {
  ...
  @ApiPropertyOptional({
    ...
    description: "Filter by compatible component type",
  })
  ...
  @ApiPropertyOptional({
    description: "Only low stock (quantity <= minQuantity)",
  })
  @IsBoolean()
  @Transform(({ value }) => value === "true" || value === true)
  @IsOptional()
