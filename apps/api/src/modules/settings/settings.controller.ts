...
export class SettingsController {
  ...
  @Get("public")
  @Public()
  @Throttle({ default: { limit: 30, ttl: 60000 } }) // 30 requests/min -- public settings
  ...
  @ApiResponse({
    status: 200,
    description: "AI provider key details (API key masked)",
  })
  ...
  @ApiResponse({
    status: 201,
    description: "AI provider key created (API key masked in response)",
  })
  @ApiResponse({
    status: 409,
    description: "Provider key already exists for this organization",
  })
