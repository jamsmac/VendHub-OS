...
export class CreateOpeningBalanceDto {
  ...
  @ApiPropertyOptional({
    description: "Total cost (auto-calculated if not provided)",
    example: 1500000.0,
  })
  @IsOptional()
  @IsNumber({ maxDecimalPlaces: 2 })
...
export class BulkCreateOpeningBalanceDto {
  @ApiProperty({
    description: "Array of opening balance records",
  ...
  @ApiPropertyOptional({
    description: "Import source (manual, excel, csv)",
    example: "excel",
  })
  @IsOptional()
  @IsString()
...
export class UpdateOpeningBalanceDto extends PartialType(
