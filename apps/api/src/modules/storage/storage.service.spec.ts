...
jest.mock("@aws-sdk/client-s3", () => ({
  ...
  CopyObjectCommand: jest
    .fn()
    .mockImplementation((params) => ({ ...params, _type: "CopyObject" })),
  HeadObjectCommand: jest
    .fn()
    .mockImplementation((params) => ({ ...params, _type: "HeadObject" })),
}));
...
describe("StorageService", () => {
  ...
  describe("listFiles", () => {
    it("should return list of files in a folder", async () => {
      ...
      mockSend.mockResolvedValue({
        Contents: [
          {
            Key: "org-1/images/photo1.jpg",
            Size: 1024,
            LastModified: lastModified,
            ETag: '"a"',
          },
          {
            Key: "org-1/images/photo2.jpg",
            Size: 2048,
            LastModified: lastModified,
            ETag: '"b"',
          },
  ...
  describe("getKeyFromUrl", () => {
    it("should extract key from CDN URL", () => {
      const result = service.getKeyFromUrl(
        "https://cdn.vendhub.test/org-1/images/file.jpg",
      );
  ...
  describe("validateFileSize", () => {
    ...
    it("should use default limit when category is default", () => {
      ...
      expect(service.validateFileSize(101 * 1024 * 1024, "default")).toBe(
        false,
      );
    });
  });
