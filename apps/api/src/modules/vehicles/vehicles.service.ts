...
export class VehiclesService {
  ...
  async create(
    ...
    if (existing) {
      throw new BadRequestException(
        `Vehicle with plate ${dto.plateNumber} already exists in this organization`,
      );
    }
  ...
  async update(
    ...
    if (dto.ownerEmployeeId !== undefined)
      vehicle.ownerEmployeeId = dto.ownerEmployeeId ?? null;
    ...
    vehicle.updatedById = userId ?? vehicle.updatedById;
