...
export class ReferencesController {
  ...
  @ApiOperation({
    ...
    description:
      "Search and filter MXIK commodity classification codes from Uzbekistan tax system. Supports text search, group/parent filtering, and pagination.",
  })
  @ApiResponse({
    status: 200,
    description: "Paginated list of goods classifiers",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Create a new MXIK goods classifier entry. Requires owner or admin role.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Update an existing MXIK goods classifier by UUID. Code field is immutable. Requires owner or admin role.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Search and filter IKPU tax identification codes. Supports text search, MXIK code filtering, marking filter, and pagination.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Create a new IKPU tax identification code. Requires owner or admin role.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Update an existing IKPU code by UUID. Code field is immutable. Requires owner or admin role.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve all VAT rates defined for Uzbekistan. Ordered by sort_order.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve a single VAT rate entry by its unique code (e.g. STANDARD, ZERO, EXEMPT).",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Update an existing VAT rate by UUID. Code field is immutable. Requires owner or admin role.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve all package types (BOX, BOTTLE, CAN, etc.). Ordered by sort_order.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Update an existing package type by UUID. Code field is immutable. Requires owner or admin role.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve all payment providers (Payme, Click, Uzum, cash, etc.). Ordered by sort_order.",
  })
  @ApiResponse({
    status: 200,
    description: "Paginated list of payment providers",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Update an existing payment provider by UUID. Code field is immutable. Requires owner or admin role.",
  })
