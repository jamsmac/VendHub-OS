        ...
        <View style={styles.statsRow}>
          <View style={styles.stat}>
            ...
            <Text
              style={[
                styles.statValue,
                item.stockLevel !== undefined && item.stockLevel < 30
          ...
          <View style={styles.stat}>
            ...
            <Text style={styles.statValue}>
              {item.currentCashAmount
                ? `${Number(item.currentCashAmount).toLocaleString()}`
                : "N/A"}
            </Text>
          </View>
        </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyTitle}>{t("machines.emptyTitle")}</Text>
            <Text style={styles.emptySubtitle}>
              {t("machines.emptySubtitle")}
            </Text>
          </View>
        }
      />
