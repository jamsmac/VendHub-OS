...
// User roles (7 roles matching UserRole enum)
export const USER_ROLES = {
  owner: { label: "Владелец", color: "red", permissions: ["*"] },
  admin: { label: "Администратор", color: "purple", permissions: ["*"] },
  manager: {
    label: "Менеджер",
    color: "blue",
    permissions: ["machines", "tasks", "inventory", "reports", "team"],
  },
  operator: {
    label: "Оператор",
    color: "amber",
    permissions: ["machines:view", "tasks:assigned", "inventory:own"],
  },
  warehouse: {
    label: "Складской",
    color: "emerald",
  ...
  accountant: {
    label: "Бухгалтер",
    color: "cyan",
    permissions: ["finance", "reports", "reconciliation"],
  },
