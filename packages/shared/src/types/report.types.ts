...
export const REPORT_TYPE_LABELS: Record<ReportType, { ru: string; uz: string }> = {
  ...
  [ReportType.SALES_BY_PRODUCT]: { ru: 'Продажи по товарам', uz: "Mahsulotlar bo'yicha sotuvlar" },
  [ReportType.SALES_BY_MACHINE]: { ru: 'Продажи по автоматам', uz: "Avtomatlar bo'yicha sotuvlar" },
  [ReportType.SALES_BY_LOCATION]: { ru: 'Продажи по локациям', uz: "Joylashuvlar bo'yicha sotuvlar" },
  [ReportType.SALES_BY_PERIOD]: { ru: 'Продажи по периодам', uz: "Davrlar bo'yicha sotuvlar" },
  [ReportType.SALES_COMPARISON]: { ru: 'Сравнение продаж', uz: 'Sotuvlarni taqqoslash' },
  [ReportType.MACHINE_PERFORMANCE]: { ru: 'Эффективность автоматов', uz: 'Avtomatlar samaradorligi' },
  [ReportType.MACHINE_UPTIME]: { ru: 'Время работы автоматов', uz: 'Avtomatlar ish vaqti' },
  [ReportType.MACHINE_ERRORS]: { ru: 'Ошибки автоматов', uz: 'Avtomat xatolari' },
  [ReportType.MACHINE_MAINTENANCE]: { ru: 'Обслуживание автоматов', uz: 'Avtomatlarni texnik xizmati' },
  [ReportType.INVENTORY_LEVELS]: { ru: 'Уровни запасов', uz: 'Zaxira darajalari' },
  [ReportType.INVENTORY_MOVEMENTS]: { ru: 'Движение запасов', uz: 'Zaxiralar harakati' },
  [ReportType.INVENTORY_TURNOVER]: { ru: 'Оборачиваемость запасов', uz: 'Zaxiralar aylanmasi' },
  [ReportType.INVENTORY_EXPIRATION]: { ru: 'Сроки годности', uz: 'Yaroqlilik muddatlari' },
  [ReportType.INVENTORY_VALUATION]: { ru: 'Оценка запасов', uz: 'Zaxiralarni baholash' },
  [ReportType.REVENUE_REPORT]: { ru: 'Отчет о выручке', uz: 'Daromad hisoboti' },
  ...
  [ReportType.TASK_REPORT]: { ru: 'Отчет по задачам', uz: 'Vazifalar hisoboti' },
  [ReportType.COMPLAINT_REPORT]: { ru: 'Отчет по жалобам', uz: 'Shikoyatlar hisoboti' },
  [ReportType.ROUTE_EFFICIENCY]: { ru: 'Эффективность маршрутов', uz: 'Marshrutlar samaradorligi' },
  [ReportType.OPERATOR_PERFORMANCE]: { ru: 'Эффективность операторов', uz: 'Operatorlar samaradorligi' },
...
export const WIDGET_TYPE_LABELS: Record<WidgetType, { ru: string; uz: string }> = {
  ...
  [WidgetType.CHART_BAR]: { ru: 'Столбчатая диаграмма', uz: 'Ustunli diagramma' },
  [WidgetType.CHART_PIE]: { ru: 'Круговая диаграмма', uz: 'Dumaloq diagramma' },
  [WidgetType.CHART_DONUT]: { ru: 'Кольцевая диаграмма', uz: 'Halqa diagramma' },
  [WidgetType.CHART_AREA]: { ru: 'Диаграмма с областями', uz: 'Maydonli diagramma' },
