...
export class CreateIkpuCodeDto {
  @ApiProperty({
    example: "10810001001",
    description: "IKPU kod (do 17 tsifr)",
  })
  @IsString()
  @Length(5, 17)
  code: string;
...
| 4.20 | ~~PORT agent-bridge~~                 | PORT   | agent-bridge       | **DONE** |
...
1. [x] **Obnovit skills/**: `vhm24-db-expert`, `vhm24-api-generator` ssylaiutsia na Drizzle/MySQL/tRPC -- perepisano na TypeORM/PostgreSQL/NestJS (2026-02-20)
2. [x] **Sozdat CLAUDE.md**: Edinyi istochnik pravdy dlia vsekh AI agentov (2026-02-20)
3. [ ] **Udalit drizzle.config.ts** iz VHM24-repo (legacy, ne ispolzuetsia)
4. [x] **Soglasovat naming**: Vybran camelCase (SnakeNamingStrategy auto-converts). ~80 files konvertirovano (2026-02-20)

---

_Plan sozdan: 03 fevralia 2026_
